  ...
  return (
    <div className="flex flex-wrap gap-[30px] justify-center">
      ...
      <div
        ...
        className="w-[150px] cursor-pointer hover:text-[#fff] text-[#8d090d] transition-colors duration-500 flex justify-center items-center self-center ml-[50px] hover:bg-[#8D090D] h-[50px] bg-[#0e0d0d] rounded-md"
      >
        PREVIOUS
      </div>
      <div
